...
user1 = User.create!(email: "leon@gmail.com", password: "123456", first_name: "Leon", last_name: "Matthaus")
user2 = User.create!(email: "marco@gmail.com", password: "123456", first_name: "Marco", last_name: "Rossi")
user3 = User.create!(email: "arnault@gmail.com", password: "123456", first_name: "Arnault", last_name: "Le Clerc")
...
car = Car.new(model: "Jaguar E-Type", color: "Red", year: 1962, price: 200, user: user1, address: "11A Buckfast St, London, E2 6EY")
...
car = Car.new(model: "Audi 100 Coupé S", color: "Blue", year: 1969, price: 180, user: user1, address: "138 Kingsland Rd, London, E2 8DY")
car.photo.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')
car.save!
...
car = Car.new(model: "Ferrari 330 GT 2+2", color: "Blue", year: 1966, price: 366, user: user1, address: "22 Holly Mount, London, NW3 6SG")
car.photo.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')
car.save!


file = URI.open("https://www.classicdriver.com/sites/default/files/styles/colorbox/public/article_images/03_34.jpg")
car = Car.new(model: "Porsche 964 Turbo", color: "White", year: 1992, price: 210, user: user2, address: "228 Munster Rd, London, SW6 6AZ")
car.photo.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')
car.save!
...
car = Car.new(model: "Bentley S2", color: "Grey", year: 1961, price: 195, user: user2, address: "43 Choumert Rd, London, SE15 4AR")
car.photo.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')
car.save!

file = URI.open("https://www.sportscarmarket.com/wp-content/uploads/2016/12/1961-maserati-3500-gt-vignale-spyder-front.jpg")
car = Car.new(model: "Maserati 3500 GT Vignale Spyder", color: "Blue", year: 1961, price: 230, user: user2, address: "40-41 Rathbone Pl, London, W1T 1HX")
car.photo.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')
car.save!
...
car = Car.new(model: "Mercedes-Benz 300SL Gullwing Coupe", color: "Black", year: 1955, price: 255, user: user2, address: "High Rd, London, N17 8EY")
car.photo.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')
car.save!

file = URI.open("https://car-from-uk.com/ebay/carphotos/full/ebay456846.jpg")
car = Car.new(model: "Cadillac Coupe Deville", color: "Pink", year: 1960, price: 160, user: user3, address: "131 Oval Rd, Croydon, CR0 6BR")
car.photo.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')
car.save!
...
car = Car.new(model: "BMW 507", color: "Blue", year: 1956, price: 206, user: user3, address: "240 Portobello Rd, London, W11 1LL")
car.photo.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')
car.save!
