...
car = Car.create(model: "Jaguar E-Type", color: "Red", year: 1962, price: 200, user: user, address: "London")
...
car = Car.create(model: "Audi 100 Coupé S", color: "Blue", year: 1969, price: 180, user: user, address: "London")
car.photo.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')
...
car = Car.create(model: "Ferrari 330 GT 2+2", color: "Blue", year: 1966, price: 366, user: user, address: "Liverpool")
car.photo.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')

file = URI.open("https://www.classicdriver.com/sites/default/files/styles/colorbox/public/article_images/03_34.jpg")
car = Car.create(model: "Porsche 964 Turbo", color: "White", year: 1992, price: 210, user: user, address: "London")
car.photo.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')
...
car = Car.create(model: "Bentley S2", color: "Grey", year: 1961, price: 195, user: user, address: "Bristol")
car.photo.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')

file = URI.open("https://www.sportscarmarket.com/wp-content/uploads/2016/12/1961-maserati-3500-gt-vignale-spyder-front.jpg")
car = Car.create(model: "Maserati 3500 GT Vignale Spyder", color: "Blue", year: 1961, price: 230, user: user, address: "Liverpool")
car.photo.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')
...
car = Car.create(model: "Mercedes-Benz 300SL Gullwing Coupe", color: "Black", year: 1955, price: 255, user: user, address: "Liverpool")
car.photo.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')

file = URI.open("https://car-from-uk.com/ebay/carphotos/full/ebay456846.jpg")
car = Car.create(model: "Cadillac Coupe Deville", color: "Pink", year: 1960, price: 160, user: user, address: "Liverpool")
car.photo.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')
...
car = Car.create(model: "BMW 507", color: "Blue", year: 1956, price: 206, user: user, address: "Liverpool")
car.photo.attach(io: file, filename: 'nes.jpg', content_type: 'image/jpg')
